...
export default function ChatBox({
  ...
  return (
    <div className="absolute top-1/2 left-1/2 transform w-[80%] translate-y-[-15%] max-h-[80vh] animate-fadeIn">
      <div className="relative bg-gradient-to-b from-slate-800/90 to-slate-900/95 backdrop-blur-xl rounded-3xl border border-slate-700/50 shadow-2xl p-6">
        <div className="h-[calc(90vh-220px)] overflow-y-auto [&::-webkit-scrollbar]:hidden [&]:scrollbar-hide">
